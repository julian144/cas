...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Koda za preverjanje je napačna.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => 'Atribut {attribute} mora vsebovati največ {max, number} {max, plural, one{znak} two{znaka} few{znake} other{znakov}}.',
