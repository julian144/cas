...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Neteisingas patikrinimo kodas.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => 'Laukelio „{attribute}“ reikšmę privalo sudaryti daugiausiai {max, number} {max, plural, one{ženklas} few{ženklai} other{ženklų}}.',
