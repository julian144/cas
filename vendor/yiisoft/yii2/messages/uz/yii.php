...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Tekshiruv kodi noto`g`ri.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '«{attribute}» qiymati maksimum {max, number} {max, plural, one{belgidan} few{belgidan} many{belgidan} other{belgidan}} oshmasligi kerak.',
