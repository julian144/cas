...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Le code de vérification est incorrect.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} doit comporter au plus {max, number} {max, plural, one{caractère} other{caractères}}.',
