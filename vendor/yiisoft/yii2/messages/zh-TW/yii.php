...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => '驗證碼不正確。',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} 只能包含最多 {max, number} 個字符。',
