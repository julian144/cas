...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'رمز التحقق غير صحيح',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} يجب أن لا يحتوي على أكثر من {max, number} {max, plural, one{حرف} few{حروف} other{حرف}}.',
