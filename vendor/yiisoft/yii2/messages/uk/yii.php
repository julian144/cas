...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Невірний код перевірки.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => 'Значення "{attribute}" повинно містити максимум {max, number} {max, plural, one{символ} few{символа} many{символів} other{символа}}.',
