...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Неправильный проверочный код.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => 'Значение «{attribute}» должно содержать максимум {max, number} {max, plural, one{символ} few{символа} many{символов} other{символа}}.',
