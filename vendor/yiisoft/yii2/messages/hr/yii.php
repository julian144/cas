...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Kod za provjeru nije točan.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} moze sadržavati najviše do {max, number} {max, plural, =1{znak} one{# znak} few{# znaka} many{# znakova} other{# znakova}}.',
