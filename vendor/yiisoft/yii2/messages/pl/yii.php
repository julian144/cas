...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Kod weryfikacyjny jest nieprawidłowy.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} musi zawierać nie więcej niż {max, number} {max, plural, one{znak} few{znaki} many{znaków} other{znaku}}.',
