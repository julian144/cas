...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Nesprávný ověřovací kód.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} může obsahovat nanejvýš {max, number} {max, plural, one{znak} few{znaky} other{znaků}}.',
