...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Ο κωδικός επαλήθευσης είναι εσφαλμένος.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => 'Το «{attribute}» πρέπει να περιέχει το πολύ {max, number} {max, plural, one{χαρακτήρα} few{χαρακτήρες} many{χαρακτήρες} other{χαρακτήρες}}.',
