...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Kód pre overenie je neplatný.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} môže obsahovať najviac {max, number} {max, plural, one{znak} other{znakov}}.',
