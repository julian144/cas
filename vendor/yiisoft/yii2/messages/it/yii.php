...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Il codice di verifica non è corretto.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} dovrebbe contenere al massimo {max, number} {max, plural, one{carattere} other{caratteri}}.',
