...
return array (
  ...
  'El código de verificación es incorrecto. Intente de nuevo.' => 'Verifikationskoden er ikke korrekt.',
  ...
  '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} skal højst indeholde {max, number} {max, plural, one{tegn} other{tegn}}.',
