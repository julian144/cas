...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Vahvistuskoodi on virheellinen.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} tulisi sisältää enintään {max, number} {max, plural, one{merkki} other{merkkiä}}.',
