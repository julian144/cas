...
return array (
  ...
  'El código de verificación es incorrecto. Intente de nuevo.' => 'Kontrollkood on vale.',
  ...
  '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} tohib sisaldada maksimaalselt {max, number} {max, plural, one{tähemärki} other{tähemärki}}.',
