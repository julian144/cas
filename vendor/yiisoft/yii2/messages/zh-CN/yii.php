...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => '验证码不正确。',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute}只能包含至多{max, number}个字符。',
