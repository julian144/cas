...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => '検証コードが正しくありません。',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} は {max} 文字以下でなければいけません。',
