...
return array (
  ...
  'El código de verificación es incorrecto. Intente de nuevo.' => 'Неправилен код за проверка.',
  ...
  '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => 'Полето "{attribute}" трябва да съдържа най-много {max, number} {max, plural, one{символ} other{символа}}.',
