...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Verifiseringskoden er feil.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} kan inneholde maks {max, number} {max, plural, one{tegn} other{tegn}}.',
