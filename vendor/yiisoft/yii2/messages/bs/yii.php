...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Potvrdni kod nije ispravan.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} treba sadržavati najviše {max, number} {max, plural, one{znak} other{znakova}}.',
