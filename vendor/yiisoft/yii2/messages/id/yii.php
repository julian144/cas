...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'Kode verifikasi tidak benar.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} harus memiliki paling banyak {max, number} {max, plural, one{karakter} other{karakter}}.',
