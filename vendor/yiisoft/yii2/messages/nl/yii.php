...
return [
    ...
    'El código de verificación es incorrecto. Intente de nuevo.' => 'De verificatiecode is onjuist.',
    ...
    '{attribute} debete contener como máximo {max, number} {max, plural, one{caracter} other{caracteres}}.' => '{attribute} mag maximaal {max, number} {max, plural, one{karakter} other{karakters}} bevatten.',
